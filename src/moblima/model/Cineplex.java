...
public class Cineplex {
	...
	public Cineplex(int noOfTheatre, int noOfMovie, int noOfStaff, String cinemaName, int cineplexId, double baseTicketCost) {
		...
		if (cineplexId == 1) {
			...
			Movie movieA = new Movie(3, 3, "NowShowing", "Bug's Life", "abc", directorA, castA, 4.2, "PG13", cineplexId, 1, 3);
			movieList.add(movieA);
			String[] directorB = new String[]{"Mohame", "Fazl"};
			String[]castB = new String[]{"Fazl", "Mohame"};
			Movie movieB = new Movie(3, 3, "Preview", "John Wick", "cde", directorB, castB, 4.1, "NC16", cineplexId, 2, 2);
			movieList.add(movieB);
			String[] directorC = new String[]{"Moham", "Faz"};
			String[]castC = new String[]{"Faz", "Moham"};
			Movie movieC = new Movie(0, 0, "ComingSoon", "Mulan", "fgh", directorC, castC, 4.0, "M18", cineplexId, 3, 1);
			...
			String[] directorA = new String[]{"Mohamed", "Fazli"};
			String[]castA = new String[]{"Fazli", "Mohamed"};
			Movie movieA = new Movie(3, 3, "NowShowing", "Bug's Life", "abc", directorA, castA, 4.2, "PG13", cineplexId, 1, 1);
			movieList.add(movieA);
			String[] directorB = new String[]{"Ju", "Xian"};
			String[]castB = new String[]{"Ju", "Xian"};
			Movie movieB = new Movie(3, 3, "Preview", "John Wick 2", "cdef", directorB, castB, 4.5, "NC16", cineplexId, 4, 2);
			movieList.add(movieB);

			String[] directorC = new String[]{"Ju", "Xia"};
			String[]castC = new String[]{"Ju", "Xia"};
			Movie movieC = new Movie(3, 3, "NowShowing", "Mulan 2", "fghi", directorC, castC, 4.6, "M18", cineplexId, 5, 3);
			movieList.add(movieC);
			this.cinemaList = new ArrayList<Cinema>();
			...
			Movie movieA = new Movie(3, 3, "Preview", "John Wick", "cde", directorA, castA, 4.1, "NC16", cineplexId, 2, 4);
			movieList.add(movieA);
			String[] directorB = new String[]{"Ju", "Xian"};
			String[]castB = new String[]{"Ju", "Xian"};
			Movie movieB = new Movie(3, 3, "Preview", "John Wick 2", "cdef", directorB, castB, 4.5, "NC16", cineplexId, 4, 2);
			...
			Movie movieC = new Movie(3, 3, "NowShowing", "Harry Potter", "fghij", directorC, castC, 4.2, "M18", cineplexId, 6, 1);
			movieList.add(movieC);
			this.cinemaList = new ArrayList<Cinema>();
